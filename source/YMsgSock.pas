...
type
  ...
  TTCPDataEvent = procedure(Sender:TObject;Buffer:TMemory;Len:integer) of object;
  ...
  public
    ...
    property OnConnectFailed:TTCPEvent read FOnConnectFailed write FOnConnectFailed;  end;
...
begin
  if Assigned(FOwner.OnData) then
    FOwner.FOnData(FOwner,FBuffer,FBLen);
end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            FBuffer := AllocMem(YAHOO_DATA_MAX);
            try
              FBLen := sock.RecvBuffer(FBuffer,YAHOO_DATA_MAX);
